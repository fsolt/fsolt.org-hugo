...
tags:
  ...
  - r
  - swiid
twitter_image: /img/swiid_v62.png
...
Version 6.2 of the SWIID is [now available](http://fsolt.org/swiid/swiid_downloads.html)!  Building on the end-to-end revision accomplished in Version 6.0 last July and the update Version 6.1 last October, this new release:
...
- calculates estimates of absolute and relative redistribution for one additional country, Latvia, for a total of sixty-seven---all of the countries for which there is source data available [on both the distribution of market income and the distribution of disposable income or consumption](http://fsolt.org/blog/2015/10/05/redistribution-observations.html).

```{r, echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
load("../../../swiid/data/swiid6_2.rda")
