...
Version 7.1 of the SWIID is [now available](http://fsolt.org/swiid/swiid_downloads.html)!  In addition to important behind-the-scenes improvements to the estimation routine, this new release:
...
```{r swiid_v70, echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
